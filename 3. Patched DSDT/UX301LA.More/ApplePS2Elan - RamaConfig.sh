...
Install_ApplePS2Elan_to_SLE="YES"                         # YES or NO
...
v4ButtonsSimulated="YES"      # YES or NO #Enable Touchpad Left/Middle/Right Buttons
...
Inertial2FingScroll="NO"         # YES or NO
...
s3FingersPressAction="NO"        # NO=Disable / 1-32=Action
...
KBackLightlvlAtBoot="-1"                       # 0-3 or 0-16 ...
