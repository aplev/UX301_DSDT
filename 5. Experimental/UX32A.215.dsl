 ...
 * 
 * Disassembly of DSDT.aml, Wed Feb 12 20:13:59 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011F46 (73542)
 *     Revision         0x02
 *     Checksum         0xB9
 *     OEM ID           "_ASUS_"
...
Store (ShiftRight (Local4, 8), DTB1) 
    ...
    Scope (_SB_.PCI0.B0D4)
    {
        ...
        {
            Name (T_6, Zero)  // T_x: Emitted by ASL Compiler
        ...
        Method (_PSS, 0, NotSerialized)  // _PSS: Performance Supported States
        {
            ...
            Else
            {
                Return (Package (One) { Package (0x06) {
    ...
    Device (RMNE)
    {
        ...
        Name (MAC, Buffer() { 0xF4, 0x0C, 0x1E, 0x7A, 0x1A, 0x76 })
        Method (_DSM, 4, NotSerialized)
        {
            If (LEqual (Arg2, Zero)) { Return (Buffer(One) { 0x03 } ) }
            Return (Package()
